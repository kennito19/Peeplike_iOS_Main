//
//  TrendingPartiesCollectionViewCell.swift
//  Peepalike
//
//  Created by Rao, Bhavesh (external - Project) on 29/03/21.
//  Copyright © 2021 Rohit. All rights reserved.
//

import UIKit

class TrendingPartiesCollectionViewCell: UICollectionViewCell {
